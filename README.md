...
5. 进入[原型构建](model/stages/prototype-building.md)、[原型重构](model/stages/prototype-refactoring.md)、[原型审查](model/stages/prototype-review.md)、[原型精修](model/stages/prototype-polishing.md)等活动指南。
