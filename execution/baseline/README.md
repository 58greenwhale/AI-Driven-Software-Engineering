...
7. [`docs/repository-initialization.md`](docs/repository-initialization.md)：Agent 工作入口和工程基线初始化；
8. [`docs/development-workflow.md`](docs/development-workflow.md)：任务、编码、评审和验收流程；
9. [`docs/agent-context-management.md`](docs/agent-context-management.md)：跨会话和多 Agent 协作规则；
10. [`docs/architecture.md`](docs/architecture.md)：技术约束；
11. [`docs/non-functional.md`](docs/non-functional.md)：性能、安全和可靠性指标；
12. [`docs/release-readiness.md`](docs/release-readiness.md)：发布前检查和 go/no-go 规则；
13. [`docs/roadmap.md`](docs/roadmap.md)：实施顺序；
14. [`docs/definition-of-done.md`](docs/definition-of-done.md)：统一完成标准。
